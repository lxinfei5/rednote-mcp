...
func NewUserProfileAction(page playwright.Page) *UserProfileAction {
	return &UserProfileAction{page: page}
}
...
func (u *UserProfileAction) selectTab(ctx context.Context, page playwright.Page, tab ProfileTab) error {
	if tab == "" || tab == TabNotes {
		return nil
	}
